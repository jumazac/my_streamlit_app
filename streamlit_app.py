...
col6.markdown("<p style='font-size:40px;'>What is this about?<br><br></p>", unsafe_allow_html=True)
...
col6.markdown("<p style='font-size:40px;'>The distinctive edge we provide?<br><br>></p>", unsafe_allow_html=True)
