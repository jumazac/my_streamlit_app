...
fig.add_trace(go.Sunburst(
    ...
    hovertemplate='<b style="font-size: 20px;">%{label} </b> <br> <span style="font-size: 14px;">Count: %{value}<br> Path %{id}<br> percentage: %{customdata[0]:.2f}<br> global_percentage: %{customdata[1]:.2f}</span>',
